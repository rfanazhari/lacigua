...
<!-- BEGIN HEAD -->
    <head>
        ...
        <link href="{{$basesite}}assets/backend/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
        ...
        <link id="style_color" href="{{$basesite}}assets/backend/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css"/>
        <link href="{{$basesite}}assets/backend/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
        <link rel="shortcut icon" href="favicon.ico"/>
    </head>
    <body class="login page-404-full-page">
        <div class="row">
            <div class="col-md-12 page-404 center">
                <br/><br/>
                <div class="number">404</div>
                <br/>
                <div>
                    <h3>{{$inv->_trans('backend.404.header404')}}</h3>
                    <p>
                        {{$inv->_trans('backend.404.text')}}<br/>
                        <a href="{{$basesite}}" class='urllink red'>{{$inv->_trans('backend.404.back')}}</a>
                    </p>
                </div>
            </div>
        </div>
