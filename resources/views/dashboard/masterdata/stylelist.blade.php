		...
		<table class="bordered">
			...
			<tfoot>
				...
				<td style="text-align: center;">
					<a href="{{$basesite}}{{$config['backend']['aliaspage']}}dashboard/masterdata/style/edit/id_{{$val['permalink']}}" class="buttonlink tooltips" data-original-title="Edit">
						<i class="fa fa-edit text-center"></i>
					</a>
				</td>
				<td>
					<img src="{{ $basesite.'assets/frontend/images/content/style/small_'.$val['StyleImage'] }}" alt="">
				</td>
				<td>
