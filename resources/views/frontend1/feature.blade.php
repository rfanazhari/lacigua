...
<section class="sale feature">
	<div class="wrapper">
		<div class="breadcrumb">
			...
			<a href="{{$basesite}}labels/select_feature">FEATURE LABELS</a><span>></span>
			<a href="{{$basesite}}feature/id_{{$getid}}">{{strtoupper($Brand->Name)}}</a>
		</div>
		<div class="headerBack">	
			<div class="boxcaptionHeader">
				<div class="logo_1 feature">
				...
				<section class="spottab artist_tab">
						<div id="parentHorizontalTab">
							...
							<div class="resp-tabs-container hor_1">
								<div>
									@include('frontend1.tab_feature_collections')
								</div>
								<div>
									@include('frontend1.tab_feature_aboutus')
								</div>
							</div>
						</div>
				</section>
