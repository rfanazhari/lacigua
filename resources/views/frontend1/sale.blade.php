<style type="text/css">
	...
	section.sale .slider.type_3 .boxFreeShip {
		width: 197px;
	    height: 197px;
	...
	section.sale .slider.type_3 .boxFreeShip .title {
		font-size: 25px;
	...
	section.sale .slider.type_3 .boxFreeShip .desc {
		font-size: 14px;
	...
	section.sale .slider.type_3 .captIsi {
		width: 100%;
	    left: 0px;
	    margin-left: 0px;
	    text-align: center;
	...
	section.sale .slider.type_3 .captIsi .title {
		margin: 0px 0 10px;
	    font-family: "robotoboldcondensed";
	    font-size: 50px;
	    color: #fff;
	...
	section.sale .slider.type_3 .captIsi .desc {
		font-family: "robotoreguler";
	    font-size: 21px;
	    color: #fff;
	}
...
<section class="sale">
	<div class="wrapper" style="">
		<div class="breadcrumb">
			...
			<a href="{{$basesite}}sale">SALE</a><span></span>
		</div>
		@if($SaleBanner)
		<div class="slider type_3 woman after_clear" style="margin-top: 20px;">
			<div class="bxslidersale">
				@foreach($SaleBanner as $obj)
				<div>
					<a href="javascript:;">
						<div class="hidecaption">
							<div class="title">{{$obj['NoteTitle']}}</div>
							<div class="desc">
								{!!$obj['NoteDescription']!!}
							</div>
							<div class="bgcolor" style="display: none">{{$obj['NoteColor']}}</div>
						</div>
						<div class="hidetext">
							...
							<div class="bgcolor" style="display: none">{{$obj['TextColor']}}</div>
						</div>
						@if($obj['Banner'])
		            	<img src="{{$basesite}}assets/frontend/images/content/salebanner/{{$obj['Banner']}}"/>
		            	@else
		            	<img src="{{$basesite}}assets/frontend/images/content/transparent.png"/>
		            	<div class="BannerColor" style="display: none">{{$obj['BannerColor']}}</div>
		            	@endif
		        	</a>
				</div>
				@endforeach
			...
			@if($SaleBanner[0]['NoteTitle'])
				<div class="title">{{$SaleBanner[0]['NoteTitle']}}</div>
				<div class="desc">
					{!!$SaleBanner[0]['NoteDescription']!!}
				</div>
				<div class="bgcolor" style="display: none">{{$SaleBanner[0]['NoteColor']}}</div>
			@endif
			</div>
			<div class="captIsi">
			@if($SaleBanner[0]['Title'])
				<div class="title">{{$SaleBanner[0]['Title']}}</div>
				<div class="desc">
					{!!$SaleBanner[0]['Description']!!}
				</div>
				<div class="bgcolor" style="display: none">{{$SaleBanner[0]['TextColor']}}</div>
			@endif
			</div>
			<div class="BannerColor" style="display: none">{{$SaleBanner[0]['BannerColor']}}</div>
		</div>
		@endif
