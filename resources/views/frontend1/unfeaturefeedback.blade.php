	...
	<div class="wrapper">
		...
		<div class="boxContentSale after_clear">
			<div class="boxFilter" id="boxFilter">
				...
				<ul class="linkMenu">
					<li><a href="{{$basesite}}{{$controller}}-feedback/id_{{$getid}}">VIEW ALL</a></li>
					<li><a href="{{$basesite}}{{$controller}}-feedback/id_{{$getid}}/main_women">WOMEN</a></li>
					<li><a href="{{$basesite}}{{$controller}}-feedback/id_{{$getid}}/main_men">MEN</a></li>
					<li><a href="{{$basesite}}{{$controller}}-feedback/id_{{$getid}}/main_kids">KIDS</a></li>
				</ul>
			</div>
				...
				<section class="spottab artist_tab">
					<div class="tabHorizontalArtist">
						<div class="after_clear nav_tab">
							...
							<a href="{{$basesite}}{{$controller}}-feedback/id_{{$getid}}" class="active">FEEDBACK</a>
							<a href="{{$basesite}}{{$controller}}-about-us/id_{{$getid}}">ABOUT US</a>
						</div>
						<div class="resp-tabs-container">
							<div class="activecontent">
								@include('frontend1.tab_unfeature_feedback')
							</div>
						</div>
					</div>
				</section>
