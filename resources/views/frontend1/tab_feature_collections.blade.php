<style type="text/css">
	section.sale .boxContentSale .gallery_spot .slider_gallery .slide li {
		margin-right: 14px;
	}
	section.sale .boxContentSale .gallery_spot .slider_gallery .slide li:last-child {
		margin-right: 0px;
	}
...
@endif
<div class="wrap-popup" id="popup-image">
    <div class="overlay-pop"></div>
    <div class="box-popup type_2" style="max-width: 650px;padding:20px;height: auto;">
        <div class="title" style="background-color: #fff;color: #000;border-bottom: 2px solid #000;margin: 0px 20px 0;text-align: left;"><span class="tp">TITLE</span>
            <span class="closepop" style="color: #000">X</span>
        </div>

        <div class="content" style="height: auto;">			    
			    
		<img src="" class="imgDisplay" style="width: 100%;box-sizing: border-box;display: inline-block;">
