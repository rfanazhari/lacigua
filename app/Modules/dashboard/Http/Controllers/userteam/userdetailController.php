...
class userdetailController extends Controller
{
    ...
    private function addnewedit() {
        ...
        $arrgroup = $this->MasterGroup->where([['master_group.namaGroup', 'not like', 'Seller %']])
                    ->orderBy($this->inv['flip']['groupname'],'ASC')->get()->toArray();
    ...
    private function views($views = ["defaultview"]) {
        ...
        ->where([['master_group.namaGroup', 'not like', 'Seller %']])
        ->select([
