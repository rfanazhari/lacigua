...
namespace App\Modules\errornie\Http\Controllers\procurement;
...
class prapprovalController extends Controller
{
	...
	public $aliasform = [
		'titlepage'	=> ['PR Approval', true, true], // Set Title Page (if DB value from database), Title Form (true or false), Breadcrumb (true or false)
	...
	private $access = [
		'module' => ['errornie', 'procurement', 'prapproval'],
