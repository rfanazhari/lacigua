...
class logController extends Controller
{
	...
	public $aliasform = [
		'titlepage'	=> ['Log System', true, true], // Set Title Page (if DB value from database), Title Form (true or false), Breadcrumb (true or false)
	...
	private $access = [
		'module' => ['errornie', 'procurement', 'log'],
