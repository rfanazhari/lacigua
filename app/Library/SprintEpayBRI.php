...
class SprintEpayBRI extends \App\Library\GlobalFunctionsCall
{
	var $ChannelID = 'LACIGEPAY01';
	...
	public function _request($array) {
		$data = array(
		    ...
		    "callbackURL"		=> 'http://localhost/git/webdevelopment/custom/lacigue/lgfull/testbri',
