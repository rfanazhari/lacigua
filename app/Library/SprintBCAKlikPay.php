...
class SprintBCAKlikPay extends \App\Library\GlobalFunctionsCall
{
	var $ChannelID = 'LACIGKP01';
	...
	public function _request($array) {
		$data = array(
		    ...
		    "transactionAmount" => $array->GrandTotalUnshipping,
		    "transactionFee"	=> $array->GrandTotalFee,
		    "transactionDate"   => $array->CreatedDate,
		    "transactionExpire" => $array->ExpiredDate,
		    "callbackURL"		=> 'http://localhost/git/webdevelopment/custom/lacigue/lgfull/testbca',
		    "description"       => $array->Description,
		    "itemDetails"		=> json_decode($array->ItemDetail,TRUE),
		    "authCode"          => hash("sha256", $array->TransactionCode.$array->GrandTotalUnshipping.$this->ChannelID.$this->SecretKey),
	...
	public function _response($request, $SprintBcava) { // not yet
		$data_sprint = array(
